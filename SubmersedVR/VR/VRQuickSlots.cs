...
public class VRQuickSlots : uGUI_QuickSlots
{
        ...
        if (active)
        {
            ...
            if (doSwitch)
            {
                ...
                if (currentSlot != lastSlot)
                {
                    ...
                    SteamVRActions::Valve.VR.SteamVR_Actions.subnautica_HapticsRight.Execute(0.0f, 0.1f, 10f, 0.5f, SteamVR_Input_Sources.Any);
                }
            }
            else
            {
    ...
    public void Activate(SteamVR_Action_Boolean fromAction, SteamVR_Input_Sources fromSource)
    {
        ...
        var isVehicleSlot = GetTarget() is Vehicle;
    ...
    {
        var stepSize = 2 * Mathf.PI / nSlots;
